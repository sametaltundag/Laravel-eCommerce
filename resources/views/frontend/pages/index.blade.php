      ...
      <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
          ...
          <div class="intro-text text-center text-md-left">
            ...
            <p>
              <a href="{{url('/').'/'.$slider->link}}" class="btn btn-sm btn-primary">Ürüne Git</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
          <a class="block-2-item" href="{{route('kadingiyim')}}">
            <figure class="image">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
          <a class="block-2-item" href="{{route('cocukgiyim')}}">
            <figure class="image">
        ...
        <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
          <a class="block-2-item" href="{{route('erkekgiyim')}}">
            <figure class="image">
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-12 col-lg-5 text-center pl-md-5">
          ...
          <p>Seçili ürünlerdeki indirimleri kaçırmayın!</p>
          <p><a href="{{route('indirimdekiurunler')}}" class="btn btn-primary btn-sm">İndirime Git</a></p>
        </div>
      </div>
    </div>
  </div>
